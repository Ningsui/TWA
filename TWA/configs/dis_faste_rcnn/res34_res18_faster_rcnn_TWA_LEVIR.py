_base_ = [
    './faster_rcnn_res18_fpn_SSDD.py'
]

model = dict(
    type='Distilling_Two_TWA',
    distill = dict(
        pretrained_stu = "/media/yangxilab/DiskA/zhangs/mmdetection_FRS/model/faste_res18_SSDD_1000_600.pth",
        teacher_cfg='./faster_rcnn_res34_fpn_SSDD.py',
        teacher_model_path='/media/yangxilab/DiskA/zhangs/mmdetection_FRS/model/faste_res34_SSDD_1000_600.pth',
